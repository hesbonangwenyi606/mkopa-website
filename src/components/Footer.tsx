      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="tel:+254700002394" className="hover:text-green-400 transition-colors">
                  📞 +254 (0)700 002 394
                </a>
              </li>
              <li>
                <a href="mailto:info@wesilymomanyi.com" className="hover:text-green-400 transition-colors">
                  ✉️ info@wesilymomanyi.com
                </a>
              </li>
              <li>📍 Nairobi, Kenya</li>
